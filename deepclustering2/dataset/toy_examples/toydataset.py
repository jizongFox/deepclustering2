...
__all__ = [
    "ShapesClasificationDataset",
    "ShapesInstanceSegmentationDataset",
    "ShapesSegmentationDataset",
]


class _ShapesDataset(Dataset):
    types = ["square", "circle", "triangle"]
    map_id = {"square": 1, "circle": 2, "triangle": 3}
    ...
    def random_shape(self, height, width):
        ...
        * Shape dimensions: A tuple of values that define the shape size
        ...
        """
        # Shape
        shape = random.choice(self.types)
        # Color
...
class ShapesClasificationDataset(_ShapesDataset):
    def __init__(
        self,
        count: int = 1000,
        max_object_scale: float = 0.25,
        ...
        super().__init__(
            count, 1, max_object_scale, height, width, transform, target_transform, seed
        )
...
class ShapesSegmentationDataset(_ShapesDataset):
    def __init__(
        self,
        count: int = 1000,
...
class ShapesInstanceSegmentationDataset(_ShapesDataset):
    def __init__(
        self,
        count: int = 1000,
