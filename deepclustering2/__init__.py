...
# CC_wrapper_path = str(Path(PROJECT_PATH) / "deepclustering2/utils/CC_wrapper.sh")
# LC_wrapper_path = str(Path(PROJECT_PATH) / "deepclustering2/utils/LOCAL_wrapper.sh")
# JA_wrapper_path = str(Path(PROJECT_PATH) / "deepclustering2/utils/JOBARRAY_wrapper.sh")
try:
    __git_hash__ = (
